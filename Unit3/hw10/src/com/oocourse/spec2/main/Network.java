...
public interface Network {
    ...
    /*@ public normal_behavior
      ...
      @ ensures getPerson(id1).isLinked(getPerson(id2)) &&
      @         getPerson(id2).isLinked(getPerson(id1));
      @ ensures getPerson(id1).queryValue(getPerson(id2)) ==
                \old(getPerson(id1).queryValue(getPerson(id2))) + value;
      @ ensures getPerson(id2).queryValue(getPerson(id1)) ==
                \old(getPerson(id2).queryValue(getPerson(id1))) + value;
      ...
      @                      \old(getPerson(id1).tags[i].hasPerson(getPerson(id2))
                                ==>
                                !getPerson(id1).tags[i].hasPerson(getPerson(id2));
      @ ensures  (\forall int i; 0 <= i && i < getPerson(id2).tags.length;
      @                      \old(getPerson(id2).tags[i].hasPerson(getPerson(id1))
                                ==>
                                !getPerson(id2).tags[i].hasPerson(getPerson(id1));
      ...
      @                                       !getPerson(id1).isLinked(getPerson(id2));
      @*/
    public /*@ safe @*/ void modifyRelation(int id1, int id2, int value)
    ...
    /*@ public normal_behavior
      ...
      @                                 getPerson(personId).containsTag(tag.getId());
      @*/
    public /*@ safe @*/ void addTag(int personId,/*@ non_null @*/Tag tag)
  ...
  @                    getPerson(personId2).getTag(tagId).hasPerson(getPerson(personId1));
      @*/
    public /*@ safe @*/ void addPersonToTag(int personId1, int personId2, int tagId)
    ...
    /*@ public normal_behavior
      ...
      @                                    !getPerson(personId).containsTag(tagId);
      @*/
    public /*@ pure @*/ int queryTagValueSum(int personId, int tagId)
    ...
    /*@ public normal_behavior
      ...
      @                                    !getPerson(personId).containsTag(tagId);
      @*/
    public /*@ pure @*/ int queryTagAgeVar(int personId, int tagId)
        throws PersonIdNotFoundException, TagIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @                                    !getPerson(personId).containsTag(tagId);
     */
    public /*@ safe @*/ void delTag(int personId, int tagId)
        throws PersonIdNotFoundException, TagIdNotFoundException;
