...
public class Runner {
    ...
    public Runner(Class<? extends Person> personClass, Class<? extends Network> networkClass,
        ...
        try {
            ...
            messageConstructor0 = messageClass.getConstructor(
                int.class, int.class, Person.class, Person.class);
            messageConstructor1 = messageClass.getConstructor(
                int.class, int.class, Person.class, Tag.class);
            emojiConstructor0 = emojiClass.getConstructor(
                int.class, int.class, Person.class, Person.class);
            emojiConstructor1 = emojiClass.getConstructor(
                int.class, int.class, Person.class, Tag.class);
            noticeConstructor0 = noticeClass.getConstructor(
                int.class, String.class, Person.class, Person.class);
            noticeConstructor1 = noticeClass.getConstructor(
                int.class, String.class, Person.class, Tag.class);
            redEnvelopeConstructor0 = redEnvelopeClass.getConstructor(
                int.class, int.class, Person.class, Person.class);
            redEnvelopeConstructor1 = redEnvelopeClass.getConstructor(
                int.class, int.class, Person.class, Tag.class);
    ...
    public Runner(Class<? extends Person> personClass, Class<? extends Network> networkClass,
        ...
        this(personClass, networkClass, tagClass,
            messageClass, emojiClass, noticeClass, redEnvelopeClass);
