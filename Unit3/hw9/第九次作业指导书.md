...
* **PersonIdNotFoundException**：
  ...
  ```java
  public class exceptions.MyPersonIdNotFoundException extends PersonIdNotFoundException {
      public exceptions.MyPersonIdNotFoundException(int id);
  }
  ```
...
* **EqualPersonIdException**：
  ...
  ```java
  public class exceptions.MyEqualPersonIdException extends EqualPersonIdException {
      public exceptions.MyEqualPersonIdException(int id);
  }
  ```
...
* **RelationNotFoundException**：
  ...
  ```java
  public class exceptions.MyRelationNotFoundException extends RelationNotFoundException {
      public exceptions.MyRelationNotFoundException(int id1, int id2);
  }
  ```
