...
def dfs(d,wel):
    ...
    if d == dd + 1 or shai == 0:
        ...
        if x == 0:
            ...
            return print_expression(random.randint(0, 2), -1 + random.randint(0, 1) * 2) + qdl() + str(x * y % 21)
    ...
    if x == 0:
        ...
        if v[0] == 3:
            return "f(" + dimension(dfs(d + 1,wel)) + "," + dimension(dfs(d + 1,wel)) + "," + dimension(dfs(d + 1,wel)) + ")"
        elif v[0] == 2:
        ...
        if v[1] == 3:
            return "g(" + dimension(dfs(d + 1,wel)) + "," + dimension(dfs(d + 1,wel)) + "," + dimension(dfs(d + 1,wel)) + ")"
        elif v[1] == 2:
        ...
        if v[2] == 3:
            return "h(" + dimension(dfs(d + 1,wel)) + "," + dimension(dfs(d + 1,wel)) + "," + dimension(dfs(d + 1,wel)) + ")"
        elif v[2] == 2:
